"""
Test solver with exact frontend data format
"""
import sys
...
rooms = [
    {"name": "C1", "type": "classroom", "capacity": 60, "location": "Block A"},
    {"name": "C2", "type": "classroom", "capacity": 60, "location": "Block A"},
    {"name": "C3", "type": "classroom", "capacity": 60, "location": "Block A"},
    {"name": "L1", "type": "lab", "capacity": 30, "location": "Block B"},
    {"name": "L2", "type": "lab", "capacity": 30, "location": "Block B"},
]

# Exact format from frontend (hours_per_week)
subjects = [
    {
        "name": "Maths 1",
        "type": "theory",
