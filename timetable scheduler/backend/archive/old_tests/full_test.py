...
# Full test data from test_constraints.py
data = {
    "teachers": [
        {
            "id": "T1",
    ...
    "subjects": [
        ...
        {"id": "OS_Lab", "name": "OS Lab", "type": "practical", "duration": 2, "teachers": ["T2"]},
        ...
        {"id": "Major_Project", "name": "Major Project", "type": "major_project", "duration": 3, "teachers": ["T4"]},
        {"id": "Mini_Project", "name": "Mini Project", "type": "mini_project", "duration": 2, "teachers": ["T4"]},
        {"id": "CN", "name": "Computer Networks", "type": "theory", "duration": 2, "teachers": ["T5"]},
        {"id": "SE", "name": "Software Engineering", "type": "theory", "duration": 1, "teachers": ["T5"]}
    ],
    "rooms": [
        {
            "id": "C301",
